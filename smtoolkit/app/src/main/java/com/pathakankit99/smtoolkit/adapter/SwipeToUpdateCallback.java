...
abstract public class SwipeToUpdateCallback extends ItemTouchHelper.Callback {
    ...
    protected SwipeToUpdateCallback(Context context) {
        mContext = context;
        mBackground = new ColorDrawable();
        backgroundColor = Color.parseColor("#00A878");
        mClearPaint = new Paint();
        mClearPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        deleteDrawable = ContextCompat.getDrawable(mContext,R.drawable.ic_edit_black_24dp);
